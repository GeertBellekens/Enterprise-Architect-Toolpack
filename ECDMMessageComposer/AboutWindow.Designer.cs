...
namespace ECDMMessageComposer
{
	partial class AboutWindow
	{
		...
		private void InitializeComponent()
		{
			...
			this.ApplicationTitle.Text = "ECDM Message Composer";
			// 
			// VersionLabel
			// 
			...
			this.HomePage.Text = "ECDM Message Composer homepage";
			...
			this.NavigatorLogo.Location = new System.Drawing.Point(167, 37);
			...
			this.Text = "About ECDM Message Composer";
