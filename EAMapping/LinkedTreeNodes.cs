...
namespace EAMapping
{
    ...
    public class LinkedTreeNodes
    {
        ...
        public LinkedTreeNodes(LinkedTreeViews tree, Mapping mapping)
        {
            ...
            //this.sourceNode = this.trees.SourceTree.AddNode(this.Mapping.source.fullMappingPath.Split('.').ToList());
            this.sourceNode.MappedEnd = mapping.source;
            //this.targetNode = this.trees.TargetTree.AddNode(this.Mapping.target.fullMappingPath.Split('.').ToList());
